...
#define SPI_ERROR_NOT_INITIALISED ((ErrorCode)MOD_ID_SPI | 4)

#define SPI_ERROR_ZERO_LENGTH_SEND ((ErrorCode)MOD_ID_SPI | 5)

#define SPI_ERROR_UNEXPECTED_ACTION_STEP ((ErrorCode)MOD_ID_SPI | 6)