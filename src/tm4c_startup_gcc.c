/**
 * # TM4C GCC Startup Source File
 * 
 * This source file is taken from revision 2.2.0.295 of the EK-TM4C123GXL 
 * Firmware Package and is used to set various startup related items. The 
 * source includes a licence statement from TI which is left here.
 * 
 * This file does not conform to the software writing standards as it is
